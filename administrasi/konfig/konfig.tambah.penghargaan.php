...
<body>
    ...
    <!---halaman -->
    <form action="konfig.koneksi.tambah.penghargaan.php" method="post" name="uploader" enctype="multipart/form-data">
    	<div class="col-lg-7"><!--input tambah dosen-->
    		<div class="panel panel-primary">
        		<div class="panel-heading">Tambah Penghargaan</div>
           		<div class="panel-body">
                	<table class="table table-condensed">
                    	<tr>
                        	<td><label for="no">No. Penghargaan</label></td>
                            <td><input type="text" id="no_penghargaan" name="no_penghargaan" class="form-control"  /></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                            	<div class="form-group">
                            		<div class='input-group date' id='datetimepicker1'>
                            			<input type="text" class="form-control" id="tanggal_penghargaan" name="tanggal_penghargaan" readonly>
                        ...
                        <tr>
                        	...
                        	<td><input type="text" d="jenis_penghargaan" name="jenis_penghargaan" class="form-control"></td>    
                        </tr>
                        <tr>
                        	<td><label for="pemberi">Pemberi</label></td>
                            <td><input type="text" id="pemberi" name="pemberi" class="form-control" /></td>
                        </tr>
                    </table>
