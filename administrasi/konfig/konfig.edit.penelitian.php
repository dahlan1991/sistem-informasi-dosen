...
<body>
    	...
    	<div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
            	<ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="konfig.tambah.penelitian.php">Tambah Penelitian<span style="font-size:16px" class="pull-right hidden-xs showopacity glyphicon glyphicon-pencil"></span></a></li>
    ...
    <!---halaman -->
    <form action="konfig.koneksi.edit.penelitian.php" method="post" name="uploader" enctype="multipart/form-data">
    	<div class="col-lg-7"><!--input tambah dosen-->
    		<div class="panel panel-primary">
        		<div class="panel-heading">Tambah Penelitian</div>
           		<div class="panel-body">
                	<?php
						$x=abs((int)$_GET['ur']);
						$y=abs((int)$_GET['n']);
						$a="select * from tb_penelitian where no_penelitian=$x and nip=$y";
						$b=mysql_query($a) or die ("".mysql_error());
						$c=mysql_fetch_array($b) or die ("".mysql_error());
					?>
                    <table class="table table-condensed">
                    	<tr>
                        	<td><label for="no">No. Penelitian</label></td>
                            <td><input type="text" id="no" name="no" class="form-control" value="<?php echo $c['no_penelitian'];?>" ></td>
                        </tr>
                        <tr>
                            <td><label for="tahun_terbit">Tahun Penelitian</label></td>
                            <td>
                            	<div class="form-group">
                            		<div class='input-group date' id='datetimepicker1'>
                            			<input type="text" class="form-control" id="tahun_penelitian" name="tahun_penelitian" value="<?php echo $c['tahun_penelitian'];?>" readonly>
                        ...
                        <tr>
                        	<td><label for="judul">Judul Penelitian</label></td>
                            <td><input type="text" id="judul_penelitian" name="judul_penelitian" class="form-control" value="<?php echo $c['judul_penelitian'];?>"></td>
                        </tr>
                        <tr>
                            <td><label for="tempat_publikasi">Tempat Publikasi</label></td>
                            <td><textarea id="tempat_publikasi" name="tempat_publikasi" class="form-control"><?php echo $c['tempat_publikasi'];?></textarea></td>
                        </tr>
                    </table>
