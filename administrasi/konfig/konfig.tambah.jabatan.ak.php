...
<body>
    ...
    <!---halaman -->
    <form action="konfig.koneksi.tambah.jabatan.ak.php" method="post" name="uploader" enctype="multipart/form-data">
    	<div class="col-lg-7"><!--input tambah dosen-->
    		<div class="panel panel-primary">
        		<div class="panel-heading">Tambah Jabatan Akademik</div>
                            ...
                            <td>
                            	<div class="form-group">
                            		<div class='input-group date' id='datetimepicker1'>
                            			<input type="text" class="form-control" id="tahun_diangkat" name="tahun_diangkat" readonly>
