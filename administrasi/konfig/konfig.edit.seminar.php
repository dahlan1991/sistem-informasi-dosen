...
<body>
    	...
    	<div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
            	<ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="konfig.tambah.seminar.php">Tambah Seminar<span style="font-size:16px" class="pull-right hidden-xs showopacity glyphicon glyphicon-pencil"></span></a></li>
    ...
    <!---halaman -->
    <form action="konfig.koneksi.edit.seminar.php" method="post" name="uploader" enctype="multipart/form-data">
    	<div class="col-lg-7"><!--input tambah dosen-->
    		<div class="panel panel-primary">
        		<div class="panel-heading">Edit Seminar</div>
           		<div class="panel-body">
                	<?php
						$x=abs((int)$_GET['ur']);
						$y=abs((int)$_GET['n']);
						$a="select * from tb_seminar where no_seminar=$x and nip=$y";
						$b=mysql_query($a) or die ("".mysql_error());
						$c=mysql_fetch_array($b) or die ("".mysql_error());
					?>
                    <table class="table table-condensed">
                    	<tr>
                        	<td><label for="no">No. Seminar</label></td>
                            <td><input type="text" id="no" name="no" class="form-control" value="<?php echo $c['no_seminar']; ?>" ></td>
                        </tr>
                        <tr>
                            <td><label for="tanggal_seminar">Tanggal Seminar</label></td>
                            <td>
                            	<div class="form-group">
                            		<div class='input-group date' id='datetimepicker1'>
                            			<input type="text" class="form-control" id="tanggal_seminar" name="tanggal_seminar" value="<?php echo $c['tanggal_seminar']; ?>" readonly>
                        ...
                        <tr>
                            <td><label for="judul_seminar">Judul Seminar</label></td>
                            <td><input type="text" id="judul_seminar" name="judul_seminar" class="form-control" value="<?php echo $c['judul_seminar']; ?>"></td>
                        </tr>
                        <tr>
                        	<td><label for="sebagai">Sebagai</label></td>
                        	<td>
                            	<select id="sebagai" name="sebagai" class="form-control">
                                	<option><?php echo $c['sebagai']; ?></option>
                                    <option>Narator</option>
                        ...
                        <tr>
                        	<td><label for="jenis_seminar">Jenis Seminar</label></td>
                            <td><input type="text" id="jenis_seminar" name="jenis_seminar" class="form-control" value="<?php echo $c['jenis_seminar']; ?>"></td>
                        </tr>
                        <tr>
                        	<td><label for="kota">Kota</label></td>
                            <td><input type="text" id="kota" name="kota" class="form-control" value="<?php echo $c['judul_seminar']; ?>"></td>
                        </tr>
                   </table>
