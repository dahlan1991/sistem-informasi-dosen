...
<body>
    ...
    <!---halaman -->
    <form action="konfig.koneksi.tambah.seminar.php" method="post" name="uploader" enctype="multipart/form-data">
    	<div class="col-lg-7"><!--input tambah dosen-->
    		<div class="panel panel-primary">
        		<div class="panel-heading">Tambah Seminar</div>
           		<div class="panel-body">
                	<table class="table table-condensed">
                            ...
                            <td>
                            	<div class="form-group">
                            		<div class='input-group date' id='datetimepicker1'>
                            			<input type="text" class="form-control" id="tanggal_seminar" name="tanggal_seminar" readonly>
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="judul_seminar" name="judul_seminar" class="form-control"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="jenis_seminar" name="jenis_seminar" class="form-control" ></td>
                        </tr>
                        <tr>
