...
<body>
    ...
    <!---halaman -->
    <form action="konfig.koneksi.edit.buku.php" method="post" name="uploader" enctype="multipart/form-data">
    	<div class="col-lg-7"><!--input tambah dosen-->
    		<div class="panel panel-primary">
        		<div class="panel-heading">Tambah Hasil Buku</div>
           		<div class="panel-body">
                	<?php
						$x=abs((int)$_GET['ur']);
						$y=abs((int)$_GET['n']);
						$a="select * from tb_buku where no_buku=$x and nip=$y";
						$b=mysql_query($a) or die ("".mysql_error());
						$c=mysql_fetch_array($b) or die ("".mysql_error());
					?>
                    <table class="table table-condensed">
                        <tr>
                        	<td><label for="no">No. Buku</label></td>
                            <td><input type="text" id="no" name="no" class="form-control" value="<?php echo $c['no_buku'];?>"  ></td>
                        </tr>
                        <tr>
                        	<td><label for="penulis">Penulis</label></td>
                            <td><input type="text" id="penulis" name="penulis" class="form-control" value="<?php echo $c['penulis'];?>"></td>             
                        </tr>
                        <tr>
                        	<td><label for="judul_buku">Judul Buku</label></td>
                            <td><textarea id="judul_buku" name="judul_buku" class="form-control"><?php echo $c['judul_buku'];?></textarea></td>                        </tr>
                        <tr>
                            <td><label for="tahun_terbit">Tahun Terbit</label></td>
                            <td>
                            	<div class="form-group">
                            		<div class='input-group date' id='datetimepicker1'>
                            			<input type="text" class="form-control" id="tahun_terbit" name="tahun_terbit"  value="<?php echo $c['tahun_terbit'];?>" readonly>
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="penerbit_buku" name="penerbit_buku" class="form-control" value="<?php echo $c['penerbit_buku'];?>"></td>
                        </tr>
