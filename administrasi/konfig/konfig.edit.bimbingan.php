...
<body>
    ...
    <!---halaman -->
    <form action="konfig.koneksi.edit.bimbingan.php" method="post" name="uploader" enctype="multipart/form-data">
    	<div class="col-lg-7"><!--input tambah dosen-->
    		<div class="panel panel-primary">
        		<div class="panel-heading">Edit Bimbingan</div>
           		<div class="panel-body">
                	<?php 
						$y=abs((int)$_GET['x']);
						$z=abs((int)$_GET['n']);
						$a="select * from tb_bimbingan where urut=$y and nip=$z";
                    ...
                    <table class="table table-condensed">
                    	<tr>
                            ...
                            <td><input type="text" id="no" name="no" class="form-control" value="<?php echo $c['no_bimbingan'];?>" ></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                            	<div class="form-group">
                            		<div class='input-group date' id='datetimepicker1'>
                            			<input type="text" class="form-control" id="tahun_bimbingan" name="tahun_bimbingan"  value="<?php echo $c['tahun_bimbingan'];?>"readonly>
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="nama_mahasiswa" name="nama_mahasiswa" class="form-control" value="<?php echo $c['nama_mahasiswa'];?>" ></td>
                        </tr>
                        <tr>
                        	<td><label for="judul">Judul</label></td>
                            <td><textarea id="judul" name="judul" class="form-control" ><?php echo $c['judul'];?></textarea></td>
                        </tr>
                    </table>
