...
<body>
    	...
    	<div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
            	<ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="konfig.tambah.pkm.php">Tambah Pengabdian Kepada Masyarakat<span style="font-size:16px" class="pull-right hidden-xs showopacity glyphicon glyphicon-pencil"></span></a></li>
                </ul>
            </div>
    ...
    <!---halaman -->
    <form action="konfig.koneksi.edit.pkm.php" method="post" name="uploader" enctype="multipart/form-data">
    	<div class="col-lg-7"><!--input tambah dosen-->
    		<div class="panel panel-primary">
        		<div class="panel-heading">Edit Pengabdian Kepada Masyarakat</div>
           		<div class="panel-body">
                	<?php
						$x=abs((int)$_GET['ur']);
						$y=abs((int)$_GET['n']);
						$a="select * from tb_pkm where no_pkm=$x and nip=$y";
						$b=mysql_query ($a) or die ("".mysql_error());
						$c=mysql_fetch_array($b) or die ("".mysql_error());
					?>
                    <table class="table table-condensed">
                    	<tr>
                        	<td><label for="no">No.PKM</label></td>
                            <td><input type="text" id="no" name="no" class="form-control" value="<?php echo $c['no_pkm']; ?>" ></td>
                        </tr>
                        <tr>
                        	<td><label for="pkm">Judul PKM</label></td>
                            <td><textarea id="pkm" name="pkm" class="form-control"><?php echo $c['judul_pkm']; ?></textarea></td>                     </tr>
                        <tr>
                            <td><label for="tahun_pkm">Tahun PKM</label></td>
                            <td>
                            	<div class="form-group">
                            		<div class='input-group date' id='datetimepicker1'>
                            			<input type="text" class="form-control" id="tahun_pkm" name="tahun_pkm" value="<?php echo $c['tahun_pkm']; ?>" readonly>
                        ...
                        <tr>
                        	<td><label for="tempat_pkm">Tempat PKM</label></td>
                            <td><textarea id="tempat_pkm" name="tempat_pkm" class="form-control"><?php echo $c['tempat_pkm']; ?></textarea></td>
                        </tr>
                        <tr>
                        	<td><label for="publikasi_pkm">Publikasi PKM</label></td>
                            <td><textarea id="publikasi_pkm" name="publikasi_pkm" class="form-control"><?php echo $c['publikasi_pkm']; ?></textarea></td>
                        </tr>
                    </table>
