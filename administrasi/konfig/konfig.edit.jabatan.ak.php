...
<body>
    	...
    	<div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
            	<ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="konfig.tambah.jabatan.ak.php">Tambah Jabatan Akademik<span style="font-size:16px" class="pull-right hidden-xs showopacity glyphicon glyphicon-pencil"></span></a></li>
    ...
    <!---halaman -->
    <form action="konfig.koneksi.edit.jabatan.ak.php" method="post" name="uploader" enctype="multipart/form-data">
    	<div class="col-lg-7"><!--input tambah dosen-->
    		<div class="panel panel-primary">
        		<div class="panel-heading">Edit Jabatan Akademik</div>
           		<div class="panel-body">
                	<?php
						$x=abs((int)$_GET['x']);
						$y=abs((int)$_GET['n']);
						$a="select * from tb_jabatan_ak where no_jabatan=$x and nip=$y";
                    ...
                    <table class="table table-condensed">
                    	<tr>
                            ...
                            <td><input type="text" id="no_jabatan" name="no_jabatan" class="form-control" value="<?php echo $c['no_jabatan'];?>" ></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                            	<div class="form-group">
                            		<div class='input-group date' id='datetimepicker1'>
                            			<input type="text" class="form-control" id="tahun_diangkat" name="tahun_diangkat" value="<?php echo $c['tahun_diangkat'];?>" readonly>
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="posisi" name="posisi" class="form-control" value="<?php echo $c['posisi'];?>"></td>
                        </tr>
                        <tr>
                        	<td><label for="no_sk">Nomor SK</label></td>
                            <td><input type="text" id="no_sk" name="no_sk" class="form-control" value="<?php echo $c['no_sk'];?>"></td>
                        </tr>
                    </table>
