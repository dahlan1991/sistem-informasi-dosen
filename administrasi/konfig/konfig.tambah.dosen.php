...
<body>
    	...
    	<div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
            	<ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="konfig.tambah.dosen.php">Tambah Dosen <span style="font-size:16px" class="pull-right hidden-xs showopacity glyphicon glyphicon-pencil"></span></a></li>
    ...
    <!---halaman -->
    <form action="konfig.koneksi.tambah.dosen.php" method="post" name="uploader" enctype="multipart/form-data">
           		...
           		<div class="panel-body">
                	<table class="table table-condensed">
                            ...
                            <td>
                            	<div class="form-group">
                            		<div class='input-group date' id='datetimepicker1'>
                            			<input type="text" class="form-control" id="tanggal" name="tanggal" readonly required>
                        ...
                        <tr>
                            ...
                            <td><textarea id="alamat" name="alamat" class="form-control" rows="5" required></textarea></td>
                        </tr>
                        <tr>
                        	<td><label for="jenis_kelamin1">Jenis Kelamin</label></td>
                            <td><select name="jenis_kelamin" id="jenis_kelamin" class="form-control" required>
                            	<option>Pilih</option>
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="telepon" name="telepon" class="form-control" required  /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="pendidikan_terakhir" id="pendidikan_terakhir" class="form-control" required>
                            </td>                                
                        </tr>
                        <tr>
                            <td><label for="jabatan1">Jabatan</label></td>
                            <td><input type="text" id="jabatan" name="jabatan" class="form-control" required /></td>
                        </tr>
                        <tr>
    	...
    	<div class="col-lg-3">
                	...
                	<div class="panel-body">
                    	<table class="table table-responsive">
                            ...
                            <tr>
                        		...
                        		<td><input type="text" id="nidn_nidk" name="nidn_nidk" class="form-control" placeholder="N.I.D.N" required></td>
                            </tr>
                        </table>
                    </div>
            </div> 
            <div class="panel panel-primary">
            	<table class="table table-responsive">
                	<tr>
                    	<td><label for="foto1">Foto</label></td>
