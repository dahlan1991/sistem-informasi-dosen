...
<head>
<meta charset="utf-8">
<title>Informasi Jabatan Akademik</title>
	<!--memanggil Bootstrap-->
    ...
    <div class="modal-header">
        ...
        <h4 class="modal-title">Informasi Jabatan Akademik</h4>
    </div>
    <!--modal body-->
    <div class="modal-body row">
    	<div class="col-lg-12">
        <?php
			$a="select * from tb_jabatan_ak order by urut";
            ...
            <table id="myTable" class="table table-striped table-hover tablesorter">
                ...
                <tbody>
                	...
                	<tr>
                        ...
                        <td><a href="konfig/konfig.edit.jabatan.ak.php?x=<?php echo $d['no_jabatan'];?>&n=<?php echo $d['nip'];?>" class="btn btn-xs btn-warning" value="Edit">Edit</a>&nbsp;<a href="konfig/konfig.koneksi.hapus.jabatan.ak.php?x=<?php echo $d['no_jabatan']?>&n=<?php echo $d['nip'];?>" class="btn btn-xs btn-danger">Hapus</a></td>
                    </tr>
                    <?php } } ?>
                </tbody>
            </table>
