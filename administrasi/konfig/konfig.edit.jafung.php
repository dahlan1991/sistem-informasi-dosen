...
<body>
    	...
    	<div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
            	<ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="konfig.tambah.jafung.php">Tambah Jabatan Fungsional<span style="font-size:16px" class="pull-right hidden-xs showopacity glyphicon glyphicon-pencil"></span></a></li>
    ...
    <!---halaman -->
    <form action="konfig.koneksi.edit.jafung.php" method="post" name="uploader" enctype="multipart/form-data">
    	<div class="col-lg-7"><!--input tambah dosen-->
    		<div class="panel panel-primary">
        		<div class="panel-heading">Edit Jabatan Fungsional</div>
           		<div class="panel-body">
                	<?php
						$x=abs((int)$_GET['ur']);
						$y=abs((int)$_GET['n']);
						$a="select * from tb_jafung where no_jafung=$x and nip=$y";
                    ...
                    <table class="table table-condensed">
                    	<tr>
                            ...
                            <td><input type="text" id="no" name="no" class="form-control" value="<?php echo $c['no_jafung'];?>" /></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                            	<div class="form-group">
                            		<div class='input-group date' id='datetimepicker1'>
                            			<input type="text" class="form-control" id="tahun_jafung" name="tahun_jafung" value="<?php echo $c['tahun_jafung'];?>" readonly>
                        ...
                        <tr>
                        	...
                        	<td><select id="jafung" name="jafung" class="form-control">
                            	<option><?php echo $c['jafung'];?></option>
                                <option></option>
                                </select>
                            </td>    
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" id="sk_jafung" name="sk_jafung" class="form-control" value="<?php echo $c['sk_jafung'];?>"></td>
                        </tr>
                        <tr>
                        	<td><label for="sk_sertifikasi">SK Sertifikasi</label></td>
                            <td><input type="text" id="sk_sertifikasi" name="sk_sertifikasi" class="form-control" value="<?php echo $c['sk_sertifikasi'];?>" ></td>
                        </tr>
                    </table>
