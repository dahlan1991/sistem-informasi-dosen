...
<body>
    ...
    <!---halaman -->
    <form action="konfig.koneksi.edit.dosen.php" method="post" name="uploader" enctype="multipart/form-data">
    		...
    		<div class="panel panel-primary">
        		<div class="panel-heading">Edit Dosen</div>
           		<div class="panel-body">
                	<?php
						$z=abs((int)$_GET['id']);
						$a="select * from tb_dosen where no=$z";
                    ...
                    <table class="table table-condensed">
                        <tr>
                            ...
                            <td><input type="text" id="nama" name="nama" class="form-control" value="<?php echo $c['nama']; ?>" /></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                            	<div class="form-group">
                            		<div class='input-group date' id='datetimepicker1'>
                            			<input type="text" class="form-control" id="tanggal" name="tanggal" readonly required value="<?php echo $c['tanggal']; ?>">
                        ...
                        <tr>
                        	<td><label for="jenis_kelamin1">Jenis Kelamin</label></td>
                            <td><select name="jenis_kelamin" id="jenis_kelamin" class="form-control" >
                            	<option><?php echo $c['jenis_kelamin']; ?></option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            <td><label for="alamat1">alamat</label></td>
                            <td><textarea id="alamat" name="alamat" class="form-control" rows="5"  required><?php echo $c['alamat']; ?></textarea></td>
                        </tr>
                        <tr>
                            <td><label for="telepon1">Telepon / HP</label></td>
                            <td><input type="text" id="telepon" name="telepon" class="form-control" value="<?php echo $c['telepon']; ?>" required  /></td>
                        </tr>
                        <tr>
                           	<td><label for="agama1">Agama</label></td>
                            <td><select name="agama" id="agama" class="form-control" >
                            	<option><?php echo $c['agama']; ?></option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            <td><label for="pendidikan">Pendidikan Terakhir</label></td>
                            <td><input type="text" name="pendidikan_terakhir" id="pendidikan_terakhir" class="form-control" value="<?php echo $c['pendidikan_terakhir']; ?>" required>
                            </td>                                
                        </tr>
                        <tr>
                            <td><label for="jabatan1">Jabatan</label></td>
                            <td><input type="text" id="jabatan" name="jabatan" class="form-control" value="<?php echo $c['jabatan']; ?>" required /></td>
                        </tr>
                        <tr>
                            <td><label for="email1">E-mail</label></td>
                            <td><input type="text" id="email" name="email" class="form-control" value="<?php echo $c['email']; ?>" required /></td>
                        </tr>                              
                    </table>
    	...
    	<div class="col-lg-3">
    		<div class="panel panel-primary">
        		<div class="panel-heading">N.I.P & N.I.D.N / N.I.D.K</div>
                	<div class="panel-body">
                    	<table class="table table-responsive">
                        	<tr>
                            	<td><label for="no">No.</td>
                                <td><input type="text" id="no" name="no" class="form-control" value="<?php echo $c['no']; ?>" readonly></td>
                            </tr>
                            <tr>
                            	<td><label for="nip1">N.I.P</label></td>
                                <td><input type="text" id="nip" name="nip" class="form-control" value="<?php echo $c['nip']; ?>" ></td>
                        	</tr>
                            <tr>
                        		<td><label for="nidn_nidk">N.I.D.N / N.I.D.K</label></td>
                        		<td><input type="text" id="nidn_nidk" name="nidn_nidk" class="form-control" value="<?php echo $c['nidn_nidk']; ?>" ></td>
                            </tr>
                        </table>
                    </div>
            </div> 
