...
<body>
    ...
    <!---halaman -->
    <form action="konfig.koneksi.tambah.pengajaran.php" method="post" name="uploader" enctype="multipart/form-data">
           		...
           		<div class="panel-body">
                	<table class="table table-condensed">
                    	<tr>
                            ...
                            <td><input type="text" id="no_pengajaran" name="no_pengajaran" class="form-control" ></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                            	<div class="form-group">
                            		<div class='input-group date' id='datetimepicker1'>
                            			<input type="text" class="form-control" id="tahun_akademik" name="tahun_akademik" readonly>
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="mata_kuliah" name="mata_kuliah" class="form-control" ></td>
                        </tr>
                        <tr>
                        	<td><label for="sk_mengajar">SK Mengajar</label></td>
                            <td><input type="text" id="sk_mengajar" name="sk_mengajar" class="form-control"></td>
                        </tr>
