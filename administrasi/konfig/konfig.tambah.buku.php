...
<body>
    ...
    <!---halaman -->
    <form action="konfig.koneksi.tambah.buku.php" method="post" name="uploader" enctype="multipart/form-data">
           		...
           		<div class="panel-body">
                	<table class="table table-condensed">
                        ...
                        <tr>
                            ...
                            <td><textarea id="judul_buku" name="judul_buku" class="form-control"></textarea></td>                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="penerbit_buku" name="penerbit_buku" class="form-control"></td>
                        </tr>
