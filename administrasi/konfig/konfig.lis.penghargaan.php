...
<head>
<meta charset="utf-8">
<title>Informasi Penghargaan</title>
	<!--memanggil Bootstrap-->
    ...
    <div class="modal-header">
        ...
        <h4 class="modal-title">Informasi Penghargaan</h4>
    </div>
    <!--modal body-->
    <div class="modal-body row">
    	<div class="col-lg-12">
        <?php
			$a="select * from tb_penghargaan order by urut";
            ...
            <table id="myTable" class="table table-striped table-hover tablesorter">
                ...
                <tbody>
                	...
                	<tr>
                        ...
                        <td><?php echo $d['tanggal_penghargaan']; ?></td>
                        <td><?php echo $d['jenis_penghargaan']; ?></td>
                        <td><?php echo $d['pemberi']; ?></td>
                        <td><a href="konfig/konfig.edit.penghargaan.php?ur=<?php echo $d['no_penghargaan'];?>&n=<?php echo $d['nip'];?>" class="btn btn-xs btn-warning" value="Edit">Edit</a>&nbsp;<a href="konfig/konfig.koneksi.hapus.penghargaan.php?x=<?php echo $d['no_penghargaan']?>&n=<?php echo $d['nip'];?>" class="btn btn-xs btn-danger">Hapus</a></td>
                    </tr>
                    <?php } } ?>
                </tbody>
            </table>
