...
<body>
    ...
    <!---halaman -->
    <form action="konfig.koneksi.tambah.penelitian.php" method="post" name="uploader" enctype="multipart/form-data">
           		...
           		<div class="panel-body">
                	<table class="table table-condensed">
                            ...
                            <td>
                            	<div class="form-group">
                            		<div class='input-group date' id='datetimepicker1'>
                            			<input type="text" class="form-control" id="tahun_penelitian" name="tahun_penelitian" readonly >
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="judul_penelitian" name="judul_penelitian" class="form-control"></td>
                        </tr>
                        <tr>
                            <td><label for="tempat_publikasi">Tempat Publikasi</label></td>
                            <td><textarea id="tempat_publikasi" name="tempat_publikasi" class="form-control"></textarea></td>
                        </tr>
                    </table>
