...
<body>
    ...
    <!---halaman -->
    <form action="konfig.koneksi.tambah.jafung.php" method="post" name="uploader" enctype="multipart/form-data">
    	<div class="col-lg-7"><!--input tambah dosen-->
    		<div class="panel panel-primary">
        		<div class="panel-heading">Tambah Jabatan Fungsional</div>
