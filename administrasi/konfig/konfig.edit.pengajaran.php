...
<body>
    	...
    	<div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
            	<ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="konfig.tambah.pengajaran.php">Tambah Pengajaran<span style="font-size:16px" class="pull-right hidden-xs showopacity glyphicon glyphicon-pencil"></span></a></li>
    ...
    <!---halaman -->
    <form action="konfig.koneksi.edit.pengajaran.php" method="post" name="uploader" enctype="multipart/form-data">
        		...
        		<div class="panel-heading">Tambah Pengajaran</div>
           		<div class="panel-body">
                	<?php
						$x=abs((int)$_GET['ur']);
						$y=abs((int)$_GET['n']);
						$a="select * from tb_pengajaran where no_pengajaran=$x and nip=$y";
                    ...
                    <table class="table table-condensed">
                    	<tr>
                        	<td><label for="no">No. Pengajaran</label></td>
                            <td><input type="text" id="no_pengajaran" name="no_pengajaran" class="form-control" value="<?php echo $c['no_pengajaran']; ?>"  ></td>
                        </tr>
                        <tr>
                            <td><label for="mulai">Tahun Akademik</label></td>
                            <td>
                            	<div class="form-group">
                            		<div class='input-group date' id='datetimepicker1'>
                            			<input type="text" class="form-control" id="tahun_akademik" name="tahun_akademik" value="<?php echo $c['tahun_akademik']; ?>" readonly>
                        ...
                        <tr>
                            ...
                            <td>
                            	<select id="semester" name="semester" class="form-control">
                                	<option><?php echo $c['semester']; ?></option>
                                    <option>1</option>
                                    <option>2</option>
                                    <option>3</option>
                                    <option>4</option>
                        ...
                        <tr>
                        	<td><label for="mata_kuliah">Nama Mata Kuliah</label></td>
                            <td><input type="text" id="mata_kuliah" name="mata_kuliah" class="form-control" value="<?php echo $c['mata_kuliah']; ?>" ></td>
                        </tr>
                        <tr>
                        	<td><label for="sk_mengajar">SK Mengajar</label></td>
                            <td><input type="text" id="sk_mengajar" name="sk_mengajar" class="form-control" value="<?php echo $c['sk_mengajar']; ?>"></td>
                        </tr>
