...
<body>
    	...
    	<div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
            	<ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="konfig.tambah.penghargaan.php">Tambah Penghargaan<span style="font-size:16px" class="pull-right hidden-xs showopacity glyphicon glyphicon-pencil"></span></a></li>
    ...
    <!---halaman -->
    <form action="konfig.koneksi.edit.penghargaan.php" method="post" name="uploader" enctype="multipart/form-data">
    	<div class="col-lg-7"><!--input tambah dosen-->
    		<div class="panel panel-primary">
        		<div class="panel-heading">Edit Penghargaan</div>
           		<div class="panel-body">
                	<?php
						$x=abs((int)$_GET['ur']);
						$y=abs((int)$_GET['n']);
						$a="select * from tb_penghargaan where no_penghargaan=$x and nip=$y";
						$b=mysql_query($a) or die ("".mysql_error());
						$c=mysql_fetch_array($b) or die ("".mysql_error());
					?>
                    <table class="table table-condensed">
                    	<tr>
                        	<td><label for="no">No. Penghargaan</label></td>
                            <td><input type="text" id="no_penghargaan" name="no_penghargaan" class="form-control" value="<?php echo $c['no_penghargaan'];?>"  /></td>
                        </tr>
                        <tr>
                            <td><label for="tanggal">Tanggal Penghargaan</label></td>
                            <td>
                            	<div class="form-group">
                            		<div class='input-group date' id='datetimepicker1'>
                            			<input type="text" class="form-control" id="tanggal_penghargaan" name="tanggal_penghargaan" value="<?php echo $c['tanggal_penghargaan'];?>" readonly>
                        ...
                        <tr>
                        	<td><label for="jenis penghargaan">Jenis Penghargaan</label></td>
                        	<td><input type="text" d="jenis_penghargaan" name="jenis_penghargaan" class="form-control" value="<?php echo $c['jenis_penghargaan'];?>"></td>    
                        </tr>
                        <tr>
                        	<td><label for="pemberi">Pemberi</label></td>
                            <td><input type="text" id="pemberi" name="pemberi" class="form-control" value="<?php echo $c['pemberi'];?>"></td>
                        </tr>
                    </table>
