...
<body>
    ...
    <!---halaman -->
    <form action="konfig.koneksi.tambah.pkm.php" method="post" name="uploader" enctype="multipart/form-data">
    	<div class="col-lg-7"><!--input tambah dosen-->
    		<div class="panel panel-primary">
        		<div class="panel-heading">Tambah Pengabdian Kepada Masyarakat</div>
           		<div class="panel-body">
                	<table class="table table-condensed">
                        ...
                        <tr>
                            ...
                            <td><textarea id="pkm" name="pkm" class="form-control"></textarea></td>                     </tr>
                        <tr>
                            <td><label for="tahun_pkm">Tahun PKM</label></td>
                            <td>
                            	<div class="form-group">
                            		<div class='input-group date' id='datetimepicker1'>
                            			<input type="text" class="form-control" id="tahun_pkm" name="tahun_pkm" readonly>
                        ...
                        <tr>
                            ...
                            <td><textarea id="tempat_pkm" name="tempat_pkm" class="form-control"></textarea></td>
                        </tr>
                        <tr>
                        	<td><label for="publikasi_pkm">Publikasi PKM</label></td>
                            <td><textarea id="publikasi_pkm" name="publikasi_pkm" class="form-control"></textarea></td>
                        </tr>
                    </table>
